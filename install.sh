...
PROYECT=${2:-'https://github.com/jhoanchq/transporte.git'}
...
EMAIL=${10:-'jhoan.chiteq@gmail.com'}
...
read -p "configurar clave SSH para actualización automática? (requiere acceso a https://github.com/profile/keys). si[s] no[n] " ssh
if [ "$ssh" = "s" ]; then
    ...
    ssh-keyscan -H github.com >> $PATH_INSTALL/$DIR/ssh/known_hosts
...
echo "Clave SSH para añadir en github"
